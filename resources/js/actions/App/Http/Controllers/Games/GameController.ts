...
setCityRecruitment.url = (
    ...
    return (
        setCityRecruitment.definition.url
            .replace('{game}', parsedArgs.game.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
...
setPlayerProduction.url = (
    ...
    return (
        setPlayerProduction.definition.url
            .replace('{game}', parsedArgs.game.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
...
updatePlayerProfile.url = (
    ...
    return (
        updatePlayerProfile.definition.url
            .replace('{game}', parsedArgs.game.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
