...
*/
const SeedFakeDataController = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/admin/seed-fake-data'
*/
SeedFakeDataController.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: SeedFakeDataController.url(options),
    method: 'post',
})
...
* @route '/admin/seed-fake-data'
*/
const SeedFakeDataControllerForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/admin/seed-fake-data'
*/
SeedFakeDataControllerForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: SeedFakeDataController.url(options),
    method: 'post',
})
