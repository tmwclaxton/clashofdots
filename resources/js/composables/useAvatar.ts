...
export const AVATAR_STYLES: {
    ...
    {
        value: 'pixel-art',
        label: 'Pixel Art (feminine)',
        description: 'Retro pixel sprite with feminine features',
    },
    {
        value: 'pixel-art-neutral',
        label: 'Pixel Art (neutral)',
        description: 'Retro pixel sprite, gender-neutral',
    },
    {
        value: 'lorelei',
        label: 'Lorelei (feminine)',
        description: 'Illustrated portrait with feminine features',
    },
    {
        value: 'lorelei-neutral',
        label: 'Lorelei (neutral)',
        description: 'Illustrated portrait, gender-neutral',
    },
    {
        value: 'adventurer',
        label: 'Adventurer (masculine)',
        description: 'Cartoon adventurer with masculine features',
    },
    {
        value: 'adventurer-neutral',
        label: 'Adventurer (neutral)',
        description: 'Cartoon adventurer, gender-neutral',
    },
...
export function avatarUrl(
    seed: string,
    style: AvatarStyle | string = 'pixel-art',
): string {
...
export function resolveAvatarSeed(user: {
