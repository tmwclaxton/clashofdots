...
show.url = (
    ...
    const parsedArgs = {
        game: typeof args.game === 'object' ? args.game.uuid : args.game,
    };
...
spectateSnapshot.url = (
    ...
    return (
        spectateSnapshot.definition.url
            .replace('{game}', parsedArgs.game.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
...
cityRecruitment.url = (
    ...
    return (
        cityRecruitment.definition.url
            .replace('{game}', parsedArgs.game.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
...
playerProduction.url = (
    ...
    return (
        playerProduction.definition.url
            .replace('{game}', parsedArgs.game.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
