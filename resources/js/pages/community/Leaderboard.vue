...
defineProps<{
    leaderboard: Paginator | undefined;
}>();
...
<template>
    ...
    <div class="flex flex-col gap-8">
        ...
        <template v-if="leaderboard === undefined">
            <div class="wod-panel animate-pulse overflow-x-auto">
                        ...
                        >
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="size-9 rounded-full bg-muted"
                                    />
                                    <div class="h-4 w-28 rounded bg-muted" />
                                </div>
                            </td>
                            <td class="px-4 py-3">
                                <div class="h-4 w-8 rounded bg-muted" />
                            </td>
                            <td class="px-4 py-3">
                                <div class="h-4 w-8 rounded bg-muted" />
                            </td>
        ...
        <div
            v-else-if="leaderboard.data.length === 0"
